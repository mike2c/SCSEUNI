...
<div class="container no-padding">
	<div class="col-md-2 col-lg-2 no-padding">
		<ul class="left-menu">
			...
			<li data-bandeja="sent"><a href="<?=base_url('Correo/Sent')?>" class="activo">Enviados <span class="badge"><?=$cantidad_sent?></span></a></li>
			<li data-bandeja="drafts"><a href="<?=base_url('Correo/Drafts')?>">Borrador <span class="badge"><?=$cantidad_drafts?></span></a></li>
		</ul>
	</div>

<div class="modal fade" id="crearFicha" role="dialog" aria-labelledby="crearFichaLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content" style="overflow-y:scroll; max-height:590px;">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="crearFichaLabel">Nueva Ficha Ocupacional</h4>
			</div>
			<div class="modal-body">
				<form action="<?=base_url('Ficha/Crear')?>" name="formCrearFicha" id="formCrearFicha" method="post" enctype="multipart/form-data">
					...
					<label for="descripcion">Breve Descripción para la publicación(<small>Obligatorio</small>):</label><br>
					...
					<div class="form-group" style="">
						...
						<input required value="<?php echo set_value("cargo"); ?>" type="text" class="form-control" name="cargo" data-trigger="focus" data-toggle="popover" data-placement="top" title="Denominación del Cargo" data-content="
					...
					<div class="form-group">
						...
						<input required value="<?php echo set_value("ubicacion"); ?>" type="text" class="form-control" name="ubicacion" data-trigger="focus" data-toggle="popover" data-placement="top" title="Ubicacion del Cargo" data-content="
					...
					<div class="form-group">
						...
						<input required maxlength="4" value="<?php echo set_value("cantidad"); ?>" title="Digite un valor numerico" pattern="^([1-9])" type="text" class="form-control" name="cantidad" data-trigger="focus" data-toggle="popover" data-placement="top" title="cantidad de puestos" data-content="
					...
					<div class="form-group">:
						...
						<input value="<?php echo set_value("jefe"); ?>" type="text" class="form-control" name="jefe" data-toggle="popover" data-placement="top" title="Jefe inmediato" data-trigger="focus" data-content="

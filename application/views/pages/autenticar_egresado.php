<div class="container" style="padding-left:1px;">
	...
	<div class="jumbotron">
		...
		<h3><small>	La universidad ya cuenta con información básica de sus egresados que se obtiene por medio de registro academico.
		Digita tu correo electronico y verifica si se encuentra registrado en el sistema, si tu correo se encuentra se enviará un mensaje a tu cuenta con
	...
	<div class="panel panel-default">
		...
		puedes ponerte en contacto con el administrador del sitio <a href="<?=base_url('contacto')?>">aqui</a> u otra autoridad de la universidad exponiendo el problema y adjuntandole 
		...
		Para obtener más información sobre las funciones y beneficios para los egresados haz click <a href="<?php echo base_url('informacion_egresado') ?>">aquí</a>
		</div>
	</div>

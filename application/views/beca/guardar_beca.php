...
<div style="padding:0px 10px;border-left:1px solid lightgray">
	...
	<form action="<?=base_url('Beca/crearBeca')?>" name="formCrearBeca" id="formCrearBeca" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<textarea required name="descripcion" value="<?php echo set_value('descripcion'); ?>" id="descripcion" cols="30" rows="4" class="form-control"></textarea>
		</div>
		<div class="form-group">
			<label for="">Seleccione la fecha en la que la publicación dejara de estar visible(<small>Obligatorio</small>)</label>
			<input autocomplete="off" class="form-control" style="width:150px;" value="<?php echo set_value('fecha_alta'); ?>" type="text" id="fecha" maxlength="10" placeholder="dd/mm/aaaa" name="fecha_alta">
		</div>
		<div class="form-group" style="">
				<label for="" class="">URL con información de la beca(<small>Obligatorio</small>)</label><br>	
				<input required style="width:360px;" value="<?php echo set_value('url'); ?>" type="text" class="form-control" name="url">
		</div>
		<div class="">

				...
				<div>
				  ...
				  <div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="profile">
				    	<table>
				    	<tr><td><img class="img-circle" src="../../public/res/perfil-usuario.jpg"></td>
						<td> <p>	
				    ...
				    <div role="tabpanel" class="tab-pane" id="cv">
				    	<table>
				    	<tr><td><img class="img-circle" src="../../public/res/curriculum.jpg"></td>
						<td> <p>	
				    ...
				    <div role="tabpanel" class="tab-pane" id="bolsa">
				    	  <table>
					    	<tr><td><img class="img-circle" src="../../public/res/bolsa_trabajo.png"></td>
							<td> <p>	
				    ...
				    <div role="tabpanel" class="tab-pane" id="byc">
				    	  <table>
					    	<tr><td><img class="img-circle" src="../../public/res/cyb.gif"></td>
							<td> <p>	

...
<div class="container" id="contenido">
	...
	<form action='<?=base_url('Curriculum/Guardar')?>'>
		...
		<div id="formacion_complementaria" class="field"><!--FORMACION COMPLEMENTARIA-->
			<div class="group-title">
				<h3>3. Formacion Complementaria</h3>
			</div>
			<div class="group-body">
				<div class='form-inline'>
					<div class='form-group'>
...
<script type="text/javascript">
	...
	function nuevaFormacionAcademica(parent){
		...
		var child = $(parent).find(".group-body").append("<div class='form-inline'><div class='form-group'> \
			<label>Nombre de la titulación</label><br><div class='input-group'><div class='titulo'> \
			</div><div class='input-group-btn'> \
			<button id='btnAgregarTitulo' onclick='agregarTitulo()' type='button' \
			class='btn btn-warning btn-sm'>Agregar</button></div><!-- /btn-group --></div> \
			<!-- /input-group --></div><div class='form-group'><label>Fecha de comienzo \
			</label><br><input style='width:auto;' class='form-control fecha' type='text' \
			name='comienzo_formacion[]' ></div><div class='form-group'><label>Fecha de finalización \
			</label><br><input style='width:auto;' class='form-control fecha' type='text' \
			name='finalizacion_formacion[]' ></div><br></div>");
